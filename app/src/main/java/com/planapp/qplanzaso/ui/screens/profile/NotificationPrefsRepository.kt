...
// 🔹 Declaración correcta de la extensión DataStore (fuera de cualquier clase)
private val Context.notificationDataStore by preferencesDataStore(name = "notification_prefs")
private val KEY_SUMMARY_TIME = stringPreferencesKey("summary_time")

// 🔹 Claves centralizadas para tus preferencias
private object Keys {
...
class NotificationPrefsRepository(private val context: Context) {
    ...
    private object Keys {
        ...
        val NEAR_EVENTS = booleanPreferencesKey("near_events")
        val REMINDERS = booleanPreferencesKey("reminders")
        val SUMMARY_TIME = stringPreferencesKey("summary_time")   // 👈 CLAVE NUEVA
    }
    ...
    // Modificar parcialmente las prefs actuales
